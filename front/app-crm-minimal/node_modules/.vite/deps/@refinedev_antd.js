...
} from "./chunk-2PM2HKVH.js";
import {
  require_extend,
  require_inline_style_parser
} from "./chunk-ZG5DNN7D.js";
import {
  Keyframes_default,
  _createSuper,
  _inherits,
  ...
  upload_default,
  useStyleRegister
} from "./chunk-BKPZZBGB.js";
import {
  _classCallCheck
} from "./chunk-QQCM6MLG.js";
import "./chunk-JR7J6XRW.js";
import "./chunk-CVEAP5VM.js";
import {
  require_dayjs_min
} from "./chunk-EUUSZTWQ.js";
import {
  _assertThisInitialized
} from "./chunk-UIUI3LQA.js";
import {
  _createClass
...
import {
  ...
  ze,
  zo
} from "./chunk-GTVQMIGW.js";
import {
  require_shim
} from "./chunk-WII55DLE.js";
import "./chunk-5SPNXVDB.js";
import "./chunk-5QKMVZBF.js";
import {
  require_interopRequireDefault
} from "./chunk-WJYH6IMG.js";
import {
  require_prop_types
} from "./chunk-GAYIKH5K.js";
import "./chunk-OXUKOADP.js";
import "./chunk-XX6SLAZ2.js";
import "./chunk-ILZT7KTU.js";
import {
  require_jsx_runtime
...
var require_escape_string_regexp = __commonJS({
  "node_modules/mdast-util-find-and-replace/node_modules/escape-string-regexp/index.js"(exports, module) {
    "use strict";
...
var Te = t(({ action: e2, resource: o2, onMutationSuccess: n2, onMutationError: r, autoSave: s, submitOnEnter: l = false, warnWhenUnsavedChanges: i, redirect: d, successNotification: c, errorNotification: f, meta: u, metaData: T, queryMeta: P, mutationMeta: x, liveMode: F, liveParams: p, mutationMode: y, dataProviderName: h, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, disableServerSideValidation: R = false } = {}) => {
  var ne, ee;
  let { options: E } = se(), z = (E == null ? void 0 : E.disableServerSideValidation) || R, b = _(), [W] = form_default.useForm(), O2 = useForm({ form: W }), { form: U } = O2, A = mx({ onMutationSuccess: n2 || void 0, onMutationError: async (N2, oe, re) => {
    if (z) {
      r == null || r(N2, oe, re);
      return;
    }
    let _2 = [], ue = U.getFieldsValue();
    _2 = Object.keys(Rr(ue)).map((he) => ({ name: zo(he), errors: void 0 })), U.setFields(_2);
    let Ne = N2 == null ? void 0 : N2.errors;
    for (let he in Ne) {
      let ye2 = Ne[he], Qe = [];
      Array.isArray(ye2) && (Qe = ye2), typeof ye2 == "string" && (Qe = [ye2]), typeof ye2 == "boolean" && ye2 && (Qe = ["Field is not valid."]), typeof ye2 == "object" && "key" in ye2 && (Qe = [b(ye2.key, ye2.message)]), _2.push({ name: zo(he), errors: Qe });
    }
    U.setFields([..._2]), r == null || r(N2, oe, re);
  }, redirect: d, action: e2, resource: o2, successNotification: c, errorNotification: f, meta: w(u, T), metaData: w(u, T), queryMeta: P, mutationMeta: x, liveMode: F, liveParams: p, mutationMode: y, dataProviderName: h, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, autoSave: s }), { formLoading: Z2, onFinish: L, queryResult: I, id: M, onFinishAutoSave: j } = A, { warnWhenUnsavedChanges: Y, setWarnWhen: $ } = Ht(), H = i ?? Y;
  import_react74.default.useEffect(() => {
    U.resetFields();
  }, [(ne = I == null ? void 0 : I.data) == null ? void 0 : ne.data, M]);
  let q2 = t((N2) => {
    l && N2.key === "Enter" && U.submit();
  }, "onKeyUp"), K = t((N2, oe) => {
    if (N2 && H && $(true), s != null && s.enabled) {
      $(false);
      let re = (s == null ? void 0 : s.onFinish) ?? ((_2) => _2);
      return j(re(oe));
    }
    return N2;
  ...
  return { form: O2.form, formProps: { ...O2.formProps, onFinish: (N2) => L(N2).catch((oe) => oe), onKeyUp: q2, onValuesChange: K, initialValues: (ee = I == null ? void 0 : I.data) == null ? void 0 : ee.data }, saveButtonProps: X, ...A, onFinish: async (N2) => await L(N2 ?? O2.form.getFieldsValue(true)) };
}, "useForm");
var Xo = t(({ modalProps: e2 = {} } = {}) => {
  let { show: o2, close: n2, visible: r } = yh({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (s) => {
    var l;
    (l = e2.onCancel) == null || l.call(e2, s), n2();
  }, open: r, visible: r }, show: o2, close: n2 };
}, "useModal");
var et = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  var $, H;
  let [d, c] = import_react75.default.useState(false), f = Ce(), { resource: u, action: T, identifier: P } = N(i.resource), x = ye(), F = me(), p = Dt(), y = i.action ?? T ?? "", h = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), m = typeof e2 == "object" && "key" in e2 ? e2.key : u && y && e2 ? `modal-${P}-${y}` : void 0, C = Te({ meta: { ...m ? { [m]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: a, formProps: S, id: v, setId: B, formLoading: k, onFinish: g, autoSaveProps: D } = C, R = _(), { warnWhen: E, setWarnWhen: z } = Ht(), { show: b, close: W, modalProps: O2 } = Xo({ modalProps: { open: o2 } }), U = O2.open || false, A = { modalProps: O2, form: a, formLoading: k, formProps: S, formResult: void 0, formValues: a.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: g, close: W, open: O2.open || false, show: b, visible: U };
  import_react75.default.useEffect(() => {
    var q2, K, X, ne;
    if (d === false && m) {
      let ee = (K = (q2 = x == null ? void 0 : x.params) == null ? void 0 : q2[m]) == null ? void 0 : K.open;
      if (typeof ee == "boolean" ? ee && b() : typeof ee == "string" && ee === "true" && b(), h) {
        let N2 = (ne = (X = x == null ? void 0 : x.params) == null ? void 0 : X[m]) == null ? void 0 : ne.id;
        N2 && (B == null || B(N2));
      }
      c(true);
    }
    ...
    var q2;
    d === true && (U && m ? F({ query: { [m]: { ...(q2 = x == null ? void 0 : x.params) == null ? void 0 : q2[m], open: true, ...h && v && { id: v } } }, options: { keepQuery: true }, type: "replace" }) : m && !U && F({ query: { [m]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [v, U, b, m, h]);
  let Z2 = { disabled: k, loading: k, onClick: () => {
    a.submit();
  } }, L = (0, import_react75.useCallback)(() => {
    if (D.status === "success" && (s != null && s.invalidateOnClose) && f({ id: v, invalidates: l || ["list", "many", "detail"], dataProviderName: i.dataProviderName, resource: P }), E)
    ...
    typeof q2 < "u" && (B == null || B(q2)), (!(y === "edit" || y === "clone") || (typeof q2 < "u" || typeof v < "u")) && A.show();
  }, [v]), { visible: M, ...j } = O2, Y = { open: M, ...j };
  return { ...C, ...A, show: I, close: L, open: U, formProps: { ...S, ...C.formProps, onValuesChange: S == null ? void 0 : S.onValuesChange, onKeyUp: S == null ? void 0 : S.onKeyUp, onFinish: async (q2) => {
    await g(q2), n2 && W(), r && a.resetFields();
  } }, modalProps: { ...Y, width: "1000px", okButtonProps: Z2, title: R(`${P}.titles.${i.action}`, `${p(`${i.action} ${(($ = u == null ? void 0 : u.meta) == null ? void 0 : $.label) ?? ((H = u == null ? void 0 : u.options) == null ? void 0 : H.label) ?? (u == null ? void 0 : u.label) ?? P}`, "singular")}`), okText: R("buttons.save", "Save"), cancelText: R("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: k };
}, "useModalForm");
var tt = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  let d = Ce(), [c, f] = import_react76.default.useState(false), { visible: u, show: T, close: P } = yh({ defaultVisible: o2 }), { resource: x, action: F, identifier: p } = N(i.resource), y = ye(), h = me(), m = i.action ?? F ?? "", C = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), a = typeof e2 == "object" && "key" in e2 ? e2.key : x && m && e2 ? `drawer-${(x == null ? void 0 : x.identifier) ?? (x == null ? void 0 : x.name)}-${m}` : void 0, S = Te({ meta: { ...a ? { [a]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: v, formProps: B, formLoading: k, id: g, setId: D, onFinish: R, autoSaveProps: E } = S;
  import_react76.default.useEffect(() => {
    var L, I, M, j;
    if (c === false && a) {
      let Y = (I = (L = y == null ? void 0 : y.params) == null ? void 0 : L[a]) == null ? void 0 : I.open;
      if (typeof Y == "boolean" ? Y ? T() : P() : typeof Y == "string" && Y === "true" && T(), C) {
        let $ = (j = (M = y == null ? void 0 : y.params) == null ? void 0 : M[a]) == null ? void 0 : j.id;
        $ && (D == null || D($));
      }
      f(true);
    }
  }, [a, y, C, D, c]), import_react76.default.useEffect(() => {
    var L;
    c === true && (u && a ? h({ query: { [a]: { ...(L = y == null ? void 0 : y.params) == null ? void 0 : L[a], open: true, ...C && g && { id: g } } }, options: { keepQuery: true }, type: "replace" }) : a && !u && h({ query: { [a]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [g, u, T, P, a, C, c]);
  let z = _(), { warnWhen: b, setWarnWhen: W } = Ht(), O2 = { disabled: k, onClick: () => {
    v.submit();
  }, loading: k }, U = { recordItemId: g, onSuccess: () => {
    D == null || D(void 0), P();
  } }, A = (0, import_react76.useCallback)(() => {
    if (E.status === "success" && (s != null && s.invalidateOnClose) && d({ id: g, invalidates: l || ["list", "many", "detail"], dataProviderName: i.dataProviderName, resource: p }), b)
      if (window.confirm(z("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        W(false);
      else
        return;
    P(), D == null || D(void 0);
  }, [b]), Z2 = (0, import_react76.useCallback)((L) => {
    typeof L < "u" && (D == null || D(L)), (!(m === "edit" || m === "clone") || (typeof L < "u" || typeof g < "u")) && T();
  }, [g]);
  return { ...S, show: Z2, close: A, formProps: { form: v, ...S.formProps, onValuesChange: B == null ? void 0 : B.onValuesChange, onKeyUp: B == null ? void 0 : B.onKeyUp, onFinish: async (L) => {
    await R(L), n2 && P(), r && v.resetFields();
  } }, drawerProps: { width: "500px", onClose: A, open: u, forceRender: true }, saveButtonProps: O2, deleteButtonProps: U, formLoading: k };
}, "useDrawerForm");
var rt = t((e2 = {}) => {
...
var vr2 = t((e2, o2, n2 = "eq") => Qn(e2, o2, n2), "getDefaultFilter");
var co2 = t((e2) => {
  let o2 = [];
  if (Array.isArray(e2))
    e2.sort((n2, r) => {
...
var fo = t((e2, o2, n2) => {
  ...
  return Object.keys(e2).map((l) => {
    var c, f;
    let i = e2[l], d = ((c = o2.filter((u) => u.operator !== "or").find((u) => u.field === l)) == null ? void 0 : c.operator) || ((f = s[l]) == null ? void 0 : f.operator);
    d !== "or" && d !== "and" && r.push({ field: l, operator: d ?? (Array.isArray(i) ? "in" : "eq"), value: i });
  }), r;
}, "mapAntdFilterToCrudFilter");
var xe = t(({ to: e2, element: o2 }) => {
  let { Link: n2 } = ae(), r = q(), s = ft();
  return import_react78.default.createElement(r === "legacy" ? n2 : s, { to: e2, replace: false, onClick: (i) => {
    i.preventDefault();
  } }, o2);
}, "PaginationLink");
var To = t(({ onSearch: e2, initialCurrent: o2, initialPageSize: n2, hasPagination: r = true, pagination: s, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: f, filters: u, sorters: T, syncWithLocation: P, resource: x, successNotification: F, errorNotification: p, queryOptions: y, liveMode: h, onLiveEvent: m, liveParams: C, meta: a, metaData: S, dataProviderName: v } = {}) => {
  let { tableQueryResult: B, current: k, setCurrent: g, pageSize: D, setPageSize: R, filters: E, setFilters: z, sorters: b, setSorters: W, sorter: O2, setSorter: U, createLinkForSyncWithLocation: A, pageCount: Z2, overtime: L } = SC({ permanentSorter: i, permanentFilter: c, initialCurrent: o2, initialPageSize: n2, pagination: s, hasPagination: r, filters: u, sorters: T, initialSorter: l, initialFilter: d, syncWithLocation: P, resource: x, defaultSetFilterBehavior: f, successNotification: F, errorNotification: p, queryOptions: y, liveMode: h, onLiveEvent: m, liveParams: C, meta: w(a, S), metaData: w(a, S), dataProviderName: v }), I = grid_default.useBreakpoint(), [M] = form_default.useForm(), j = useForm({ form: M }), Y = Is(h), $ = r === false ? "off" : "server", H = ((s == null ? void 0 : s.mode) ?? $) !== "off", q2 = w(u == null ? void 0 : u.initial, d), { data: K, isFetched: X, isLoading: ne } = B, ee = t((re, _2, ue) => {
    if (_2 && Object.keys(_2).length > 0) {
      let de = fo(_2, E, q2);
      z(de);
    }
  ...
  }, "onChange"), N2 = t(async (re) => {
    if (e2) {
      let _2 = await e2(re);
      z(_2), H && (g == null || g(1));
    }
  }, "onFinish"), oe = t(() => H ? { itemRender: (re, _2, ue) => {
    var Ne;
  ...
  return { searchFormProps: { ...j.formProps, onFinish: N2 }, tableProps: { dataSource: K == null ? void 0 : K.data, loading: Y === "auto" ? ne : !X, onChange: ee, pagination: oe(), scroll: { x: true } }, tableQueryResult: B, sorters: b, sorter: O2, filters: E, setSorters: W, setSorter: U, setFilters: z, current: k, setCurrent: g, pageSize: D, setPageSize: R, pageCount: Z2, createLinkForSyncWithLocation: A, overtime: L };
}, "useTable");
var Or2 = t(({ autoSubmitClose: e2 = true, ...o2 } = {}) => {
  let n2 = To({ ...o2, successNotification: void 0, errorNotification: void 0 }), r = Te({ ...o2, action: "edit", redirect: false }), { id: s, setId: l, saveButtonProps: i } = r, d = { onClick: () => {
    l(void 0);
  } }, c = t((u) => ({ onClick: () => l(u) }), "editButtonProps"), f = t((u) => u === s, "isEditing");
  return { ...n2, ...r, formProps: { ...r.formProps, onFinish: async (u) => {
    let T = await r.onFinish(u);
    return e2 && l(void 0), T;
  } }, saveButtonProps: i, cancelButtonProps: d, editButtonProps: c, isEditing: f };
}, "useEditableTable");
var Rf = t((e2) => {
  let { queryResult: o2, defaultValueQueryResult: n2, onSearch: r, options: s } = TC(e2);
...
var zf = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: f, defaultValue: u, onLiveEvent: T, liveParams: P, meta: x, metaData: F, dataProviderName: p }) => {
  let { queryResult: y, options: h } = TC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: f, defaultValue: u, onLiveEvent: T, liveParams: P, meta: w(x, F), metaData: w(x, F), dataProviderName: p });
  return { checkboxGroupProps: { options: h, defaultValue: u }, queryResult: y };
}, "useCheckboxGroup");
var Xf = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: f, defaultValue: u, onLiveEvent: T, liveParams: P, meta: x, metaData: F, dataProviderName: p }) => {
  let { queryResult: y, options: h } = TC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: f, defaultValue: u, onLiveEvent: T, liveParams: P, meta: w(x, F), metaData: w(x, F), dataProviderName: p });
  return { radioGroupProps: { options: h, defaultValue: u }, queryResult: y };
}, "useRadioGroup");
var uy = t(({ resource: e2, resourceName: o2, mapData: n2 = t((u) => u, "mapData"), paparseOptions: r, batchSize: s = Number.MAX_SAFE_INTEGER, onFinish: l, meta: i, metaData: d, dataProviderName: c, onProgress: f } = {}) => {
  let u = _(), { resource: T } = N(e2 ?? o2), { mutationResult: P, isLoading: x, handleChange: F } = ph({ resource: (T == null ? void 0 : T.identifier) ?? (T == null ? void 0 : T.name), mapData: n2, paparseOptions: r, batchSize: s, meta: w(i, d), metaData: w(i, d), dataProviderName: c, onFinish: l, onProgress: f ?? (({ totalAmount: p, processedAmount: y }) => {
    if (p > 0 && y > 0) {
      let h = import_react79.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react79.default.createElement(progress_default, { type: "circle", percent: Math.floor(y / p * 100), width: 50, strokeColor: "#1890ff", status: "normal" }), import_react79.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, u("notifications.importProgress", { processed: y, total: p }, `Importing: ${y}/${p}`)));
      notification_default.open({ description: h, message: null, key: `${T}-import`, duration: 0 }), y >= p, y === p && setTimeout(() => {
        notification_default.destroy(`${T}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: F, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: x }, mutationResult: P, isLoading: x };
}, "useImport");
var Xr = t(({ resource: e2, initialCurrent: o2, initialPageSize: n2, pagination: r, hasPagination: s = true, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: f, filters: u, sorters: T, onSearch: P, queryOptions: x, syncWithLocation: F, successNotification: p, errorNotification: y, liveMode: h, onLiveEvent: m, liveParams: C, meta: a, metaData: S, dataProviderName: v } = {}) => {
  let { sorters: B, sorter: k, filters: g, current: D, pageSize: R, pageCount: E, setFilters: z, setCurrent: b, setPageSize: W, setSorter: O2, setSorters: U, createLinkForSyncWithLocation: A, tableQueryResult: Z2, overtime: L } = SC({ resource: e2, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, filters: u, sorters: T, defaultSetFilterBehavior: f, initialCurrent: o2, initialPageSize: n2, queryOptions: x, successNotification: p, errorNotification: y, liveMode: h, onLiveEvent: m, liveParams: C, meta: w(a, S), metaData: w(a, S), syncWithLocation: F, dataProviderName: v, pagination: r, hasPagination: s }), I = s === false ? "off" : "server", M = ((r == null ? void 0 : r.mode) ?? I) !== "off", j = grid_default.useBreakpoint(), Y = Is(h), [$] = form_default.useForm(), { data: H, isFetched: q2, isLoading: K } = Z2, X = t((N2, oe) => {
    M && (b(N2), W(oe || 10));
  }, "onChange"), ne = t(async (N2) => {
    if (P) {
      let oe = await P(N2);
      return M && (b == null || b(1)), z(oe);
    }
  }, "onFinish"), ee = t(() => M ? { itemRender: (N2, oe, re) => {
    var ue;
    let _2 = A({ pagination: { pageSize: R, current: N2 }, sorters: B, filters: g });
    if (oe === "page")
      return (0, import_react80.createElement)(xe, { to: _2, element: `${N2}` });
    if (oe === "next" || oe === "prev")
      return (0, import_react80.createElement)(xe, { to: _2, element: re });
    if (oe === "jump-next" || oe === "jump-prev") {
      let de = (ue = re == null ? void 0 : re.props) == null ? void 0 : ue.children;
      return (0, import_react80.createElement)(xe, { to: _2, element: import_react80.Children.count(de) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, de) : de });
    }
    return re;
  }, pageSize: R, current: D, simple: !j.sm, total: H == null ? void 0 : H.total, onChange: X } : false, "antdPagination");
  return { searchFormProps: { form: $, onFinish: ne }, listProps: { dataSource: H == null ? void 0 : H.data, loading: Y === "auto" ? K : !q2, pagination: ee() }, queryResult: Z2, filters: g, setFilters: z, sorter: k, setSorter: O2, sorters: B, setSorters: U, current: D, setCurrent: b, pageSize: R, setPageSize: W, pageCount: E, createLinkForSyncWithLocation: A, overtime: L };
}, "useSimpleList");
var Ey = t(() => {
...
var ho = t(({ message: e2, cancelMutation: o2, undoableTimeout: n2 }) => import_react86.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react86.default.createElement(progress_default, { type: "circle", percent: (n2 ?? 0) * 20, format: (r) => r && r / 20, width: 50, strokeColor: "#1890ff", status: "normal" }), import_react86.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react86.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: o2, disabled: n2 === 0, icon: import_react86.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
...
var rT = t(() => {
  ...
  return { open: ({ key: r, message: s, description: l, type: i, cancelMutation: d, undoableTimeout: c }) => {
    i === "progress" ? o2.open({ key: r, description: import_react85.default.createElement(ho, { notificationKey: r, message: s, cancelMutation: () => {
...
var mt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var { SubMenu: Dn } = menu_default;
var Po = t(({ Title: e2, render: o2, meta: n2 }) => {
  let [r, s] = (0, import_react88.useState)(false), [l, i] = (0, import_react88.useState)(false), d = to(), c = q(), f = ft(), { warnWhen: u, setWarnWhen: T } = Ht(), { Link: P } = ae(), x = c === "legacy" ? P : f, F = Mn(), p = _(), { menuItems: y, selectedKey: h, defaultOpenKeys: m } = ji({ meta: n2 }), C = grid_default.useBreakpoint(), { hasDashboard: a } = se(), S = Z(), { mutate: v } = vr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), B = typeof C.lg > "u" ? false : !C.lg, k = e2 ?? F ?? Co, g = t((A, Z2) => A.map((L) => {
    let { icon: I, label: M, route: j, key: Y, name: $, children: H, parentName: q2, meta: K, options: X } = L;
    if (H.length > 0)
      return import_react88.default.createElement(hu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(Dn, { key: L.key, icon: I ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: M }, g(H, Z2)));
    let ne = Y === Z2, ee = !(w(K == null ? void 0 : K.parent, X == null ? void 0 : X.parent, q2) !== void 0 && H.length === 0);
    return import_react88.default.createElement(hu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: ne ? "bold" : "normal" }, icon: I ?? (ee && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(x, { to: j ?? "" }, M), !r && ne && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), D = t(() => {
    u ? window.confirm(p("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (T(false), v()) : v();
  }, "handleLogout"), R = d && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: D, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, p("buttons.logout", "Logout")), E = a ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: h === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(x, { to: "/" }, p("dashboard.title", "Dashboard")), !r && h === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, z = g(y, h), b = t(() => o2 ? o2({ dashboard: E, items: z, logout: R, collapsed: r }) : import_react88.default.createElement(import_react88.default.Fragment, null, E, z, R), "renderSider"), W = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: h ? [h] : [], defaultOpenKeys: m, mode: "inline", onClick: () => {
    i(false), C.lg || s(true);
  } }, b())), "renderMenu"), O2 = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: l, onClose: () => i(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(k, { collapsed: false }), W()))), import_react88.default.createElement(button_default, { style: mt, size: "large", onClick: () => i(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, t(() => B ? O2() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: r, onCollapse: (A) => s(A), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(k, { collapsed: r }), W()), "renderContent")());
}, "Sider");
var { Text: An } = typography_default;
var Fo = t(() => {
  let e2 = Z(), { data: o2 } = Or({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
...
var On = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l }) => {
  let i = grid_default.useBreakpoint(), d = n2 ?? Po, c = o2 ?? Fo, f = typeof i.sm > "u" ? true : i.sm;
  return import_react87.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react87.default.createElement(d, { Title: r }), import_react87.default.createElement(layout_default, null, import_react87.default.createElement(c, null), import_react87.default.createElement(layout_default.Content, null, import_react87.default.createElement("div", { style: { minHeight: 360, padding: f ? 24 : 12 } }, e2), l && import_react87.default.createElement(l, null)), s && import_react87.default.createElement(s, null)));
}, "Layout");
var Co = t(({ collapsed: e2 }) => {
  let o2 = q(), n2 = ft(), { Link: r } = ae();
...
var Tt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var { SubMenu: ls } = menu_default;
var { useToken: ps } = theme_default;
var vo2 = t(({ Title: e2, render: o2, meta: n2 }) => {
  let { token: r } = ps(), [s, l] = (0, import_react92.useState)(false), [i, d] = (0, import_react92.useState)(false), c = to(), f = q(), u = ft(), { warnWhen: T, setWarnWhen: P } = Ht(), { Link: x } = ae(), F = f === "legacy" ? x : u, p = Mn(), y = _(), { menuItems: h, selectedKey: m, defaultOpenKeys: C } = ji({ meta: n2 }), a = grid_default.useBreakpoint(), { hasDashboard: S } = se(), v = Z(), { mutate: B } = vr({ v3LegacyAuthProviderCompatible: !!(v != null && v.isLegacy) }), k = typeof a.lg > "u" ? false : !a.lg, g = e2 ?? p ?? ce, D = t((A, Z2) => A.map((L) => {
    let { icon: I, label: M, route: j, key: Y, name: $, children: H, parentName: q2, meta: K, options: X } = L;
    if (H.length > 0)
      return import_react92.default.createElement(hu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(ls, { key: L.key, icon: I ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: M }, D(H, Z2)));
    let ne = Y === Z2, ee = !(w(K == null ? void 0 : K.parent, X == null ? void 0 : X.parent, q2) !== void 0 && H.length === 0);
    return import_react92.default.createElement(hu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.Item, { key: L.key, icon: I ?? (ee && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(F, { to: j ?? "" }, M), !s && ne && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), R = t(() => {
    T ? window.confirm(y("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (P(false), B()) : B();
  }, "handleLogout"), E = c && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => R(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, y("buttons.logout", "Logout")), z = S ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(F, { to: "/" }, y("dashboard.title", "Dashboard")), !s && m === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, b = D(h, m), W = t(() => o2 ? o2({ dashboard: z, items: b, logout: E, collapsed: s }) : import_react92.default.createElement(import_react92.default.Fragment, null, z, b, E), "renderSider"), O2 = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: m ? [m] : [], defaultOpenKeys: C, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    d(false), a.lg || l(true);
  } }, W())), "renderMenu"), U = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: i, onClose: () => d(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated } }, import_react92.default.createElement(g, { collapsed: false })), O2()))), import_react92.default.createElement(button_default, { style: Tt, size: "large", onClick: () => d(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return k ? U() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` }, collapsible: true, collapsed: s, onCollapse: (A) => l(A), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: r.colorBgElevated } }, s ? import_react92.default.createElement(RightOutlined_default, { style: { color: r.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: r.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: s ? "80px" : "200px", padding: s ? "0" : "0 16px", display: "flex", justifyContent: s ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(g, { collapsed: s })), O2());
}, "ThemedSider");
var { Text: Ts } = typography_default;
var { useToken: gs } = theme_default;
var Lo = t(() => {
  let { token: e2 } = gs(), o2 = Z(), { data: n2 } = Or({ v3LegacyAuthProviderCompatible: !!(o2 != null && o2.isLegacy) });
...
var hs = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l }) => {
  let i = grid_default.useBreakpoint(), d = n2 ?? vo2, c = o2 ?? Lo, f = typeof i.sm > "u" ? true : i.sm;
  return import_react91.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react91.default.createElement(d, { Title: r }), import_react91.default.createElement(layout_default, null, import_react91.default.createElement(c, null), import_react91.default.createElement(layout_default.Content, null, import_react91.default.createElement("div", { style: { minHeight: 360, padding: f ? 24 : 12 } }, e2), l && import_react91.default.createElement(l, null)), s && import_react91.default.createElement(s, null)));
}, "ThemedLayout");
...
var ce = t(({ collapsed: e2, icon: o2 = ks, text: n2 = Ls, wrapperStyles: r }) => {
  let { token: s } = vs(), l = q(), i = ft(), { Link: d } = ae();
...
var Eo = t(({ Title: e2, render: o2, meta: n2, fixed: r, activeItemDisabled: s = false }) => {
  let { token: l } = _s(), { siderCollapsed: i, setSiderCollapsed: d, mobileSiderOpen: c, setMobileSiderOpen: f } = dt(), u = to(), T = q(), P = ft(), { warnWhen: x, setWarnWhen: F } = Ht(), { Link: p } = ae(), y = T === "legacy" ? p : P, h = Mn(), m = _(), { menuItems: C, selectedKey: a, defaultOpenKeys: S } = ji({ meta: n2 }), v = grid_default.useBreakpoint(), { hasDashboard: B } = se(), k = Z(), { mutate: g } = vr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof v.lg > "u" ? false : !v.lg, R = e2 ?? h ?? wo, E = t((I, M) => I.map((j) => {
    let { icon: Y, label: $, route: H, key: q2, name: K, children: X, parentName: ne, meta: ee, options: N2 } = j;
    if (X.length > 0)
      return import_react96.default.createElement(hu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(Ys, { key: j.key, icon: Y ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: $ }, E(X, M)));
    let oe = q2 === M, re = !(w(ee == null ? void 0 : ee.parent, N2 == null ? void 0 : N2.parent, ne) !== void 0 && X.length === 0), _2 = s && oe ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(hu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(menu_default.Item, { key: j.key, icon: Y ?? (re && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: _2 }, import_react96.default.createElement(y, { to: H ?? "", style: _2 }, $), !i && oe && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), z = t(() => {
    x ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (F(false), g()) : g();
  }, "handleLogout"), b = u && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => z(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), W = B ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(y, { to: "/" }, m("dashboard.title", "Dashboard")), !i && a === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, O2 = E(C, a), U = t(() => o2 ? o2({ dashboard: W, items: O2, logout: b, collapsed: i }) : import_react96.default.createElement(import_react96.default.Fragment, null, W, O2, b), "renderSider"), A = t(() => import_react96.default.createElement(menu_default, { selectedKeys: a ? [a] : [], defaultOpenKeys: S, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    f(false);
  } }, U()), "renderMenu"), Z2 = t(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: c, onClose: () => f(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: l.colorBgContainer, borderRight: `1px solid ${l.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: l.colorBgElevated } }, import_react96.default.createElement(R, { collapsed: false })), A()))), import_react96.default.createElement(button_default, { style: Ct, size: "large", onClick: () => f(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (D)
    return Z2();
...
var Ro = t(({ isSticky: e2, sticky: o2 }) => {
  let { token: n2 } = sa(), r = Z(), { data: s } = Or({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) });
  ...
  return w(o2, e2) && (i.position = "sticky", i.top = 0, i.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: i }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (s == null ? void 0 : s.name) && import_react97.default.createElement(na, { strong: true }, s.name), (s == null ? void 0 : s.avatar) && import_react97.default.createElement(avatar_default, { src: s == null ? void 0 : s.avatar, alt: s == null ? void 0 : s.name }))));
}, "ThemedHeaderV2");
var ia = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l, initialSiderCollapsed: i }) => {
  let d = grid_default.useBreakpoint(), c = n2 ?? Eo, f = o2 ?? Ro, u = typeof d.sm > "u" ? true : d.sm, T = !!c({ Title: r });
  return import_react95.default.createElement(bo, { initialSiderCollapsed: i }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: T }, import_react95.default.createElement(c, { Title: r }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(f, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: u ? 24 : 12 } }, e2), l && import_react95.default.createElement(l, null)), s && import_react95.default.createElement(s, null))));
}, "ThemedLayoutV2");
...
var wo = t(({ collapsed: e2, icon: o2 = Ta, text: n2 = ya, wrapperStyles: r }) => {
  let { token: s } = fa(), l = q(), i = ft(), { Link: d } = ae();
...
var Vo = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  let c = (0, import_react99.useContext)(ut), f = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, u = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, T = _(), P = q(), x = ft(), { Link: F } = ae(), p = P === "legacy" ? F : x, { createUrl: y } = le(), { resource: h } = N(e2 ?? o2), { data: m } = Ks({ resource: h == null ? void 0 : h.name, action: "create", queryOptions: { enabled: f }, params: { resource: h } }), C = t(() => m != null && m.can ? "" : m != null && m.reason ? m.reason : T("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), a = h ? y(h, s) : "";
  return f && u && !(m != null && m.can) ? null : import_react99.default.createElement(p, { to: a, replace: false, onClick: (S) => {
    if ((m == null ? void 0 : m.can) === false) {
      S.preventDefault();
      return;
    }
    i && (S.preventDefault(), i(S));
  } }, import_react99.default.createElement(button_default, { icon: import_react99.default.createElement(PlusSquareOutlined_default, null), disabled: (m == null ? void 0 : m.can) === false, title: C(), className: n.CreateButton, type: "primary", ...d }, !n2 && (l ?? T("buttons.create", "Create"))));
}, "CreateButton");
var Ho = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let f = (0, import_react100.useContext)(ut), u = (s == null ? void 0 : s.enabled) ?? f.options.buttons.enableAccessControl, T = (s == null ? void 0 : s.hideIfUnauthorized) ?? f.options.buttons.hideIfUnauthorized, P = _(), x = q(), F = ft(), { Link: p } = ae(), y = x === "legacy" ? p : F, { editUrl: h } = le(), { id: m, resource: C } = N(e2 ?? o2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "edit", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: u } }), S = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : P("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 ?? m) ? h(C, n2 ?? m, l) : "";
  return u && T && !(a != null && a.can) ? null : import_react100.default.createElement(y, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S(), className: n.EditButton, ...c }, !r && (i ?? P("buttons.edit", "Edit"))));
}, "EditButton");
var Ye = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, onSuccess: r, mutationMode: s, children: l, successNotification: i, errorNotification: d, hideText: c = false, accessControl: f, metaData: u, meta: T, dataProviderName: P, confirmTitle: x, confirmOkText: F, confirmCancelText: p, invalidates: y, ...h }) => {
  let m = (0, import_react101.useContext)(ut), C = (f == null ? void 0 : f.enabled) ?? m.options.buttons.enableAccessControl, a = (f == null ? void 0 : f.hideIfUnauthorized) ?? m.options.buttons.hideIfUnauthorized, S = _(), { id: v, resource: B, identifier: k } = N(e2 ?? o2), { mutationMode: g } = ze(), D = s ?? g, { mutate: R, isLoading: E, variables: z } = ca(), { data: b } = Ks({ resource: B == null ? void 0 : B.name, action: "delete", params: { id: n2 ?? v, resource: B }, queryOptions: { enabled: C } }), W = t(() => b != null && b.can ? "" : b != null && b.reason ? b.reason : S("buttons.notAccessTitle", "You don't have permission to access"), "disabledTitle"), { setWarnWhen: O2 } = Ht();
  return C && a && !(b != null && b.can) ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: F ?? S("buttons.delete", "Delete"), cancelText: p ?? S("buttons.cancel", "Cancel"), okType: "danger", title: x ?? S("buttons.confirm", "Are you sure?"), okButtonProps: { disabled: E }, onConfirm: () => {
    (n2 ?? v) && k && (O2(false), R({ id: n2 ?? v ?? "", resource: k, mutationMode: D, successNotification: i, errorNotification: d, meta: w(T, u), metaData: w(T, u), dataProviderName: P, invalidates: y }, { onSuccess: (U) => {
      r && r(U);
    } }));
  }, disabled: typeof (h == null ? void 0 : h.disabled) < "u" ? h.disabled : (b == null ? void 0 : b.can) === false }, import_react101.default.createElement(button_default, { danger: true, loading: (n2 ?? v) === (z == null ? void 0 : z.id) && E, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: W(), disabled: (b == null ? void 0 : b.can) === false, className: n.DeleteButton, ...h }, !c && (l ?? S("buttons.delete", "Delete"))));
}, "DeleteButton");
var _e = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, dataProviderName: s, children: l, onClick: i, meta: d, metaData: c, ...f }) => {
  let u = _(), T = useQueryClient(), P = Ce(), { resources: x, identifier: F, id: p } = N(e2 ?? o2), y = !!T.isFetching({ queryKey: vo(F, O(F, s, x)).detail(n2 ?? p) }), h = t(() => {
    P({ id: n2 ?? p, invalidates: ["detail"], dataProviderName: s, resource: F });
  }, "handleInvalidate");
  return import_react102.default.createElement(button_default, { onClick: (m) => {
    i ? i(m) : h();
  }, icon: import_react102.default.createElement(RedoOutlined_default, { spin: y }), className: n.RefreshButton, ...f }, !r && (l ?? u("buttons.refresh", "Refresh")));
}, "RefreshButton");
var Si = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let f = (0, import_react103.useContext)(ut), u = (s == null ? void 0 : s.enabled) ?? f.options.buttons.enableAccessControl, T = (s == null ? void 0 : s.hideIfUnauthorized) ?? f.options.buttons.hideIfUnauthorized, { showUrl: P } = le(), x = q(), F = ft(), { Link: p } = ae(), y = x === "legacy" ? p : F, h = _(), { id: m, resource: C } = N(e2 ?? o2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "show", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: u } }), S = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? P(C, n2 ?? m, l) : "";
  return u && T && !(a != null && a.can) ? null : import_react103.default.createElement(y, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S(), className: n.ShowButton, ...c }, !r && (i ?? h("buttons.show", "Show"))));
}, "ShowButton");
var Ze = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  var B;
  let c = (0, import_react104.useContext)(ut), f = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, u = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, { listUrl: T } = le(), P = q(), x = ft(), { Link: F } = ae(), p = Dt(), y = P === "legacy" ? F : x, h = _(), { resource: m, identifier: C } = N(e2 ?? o2), { data: a } = Ks({ resource: m == null ? void 0 : m.name, action: "list", queryOptions: { enabled: f }, params: { resource: m } }), S = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = m ? T(m, s) : "";
  return f && u && !(a != null && a.can) ? null : import_react104.default.createElement(y, { to: v, replace: false, onClick: (k) => {
    if ((a == null ? void 0 : a.can) === false) {
      k.preventDefault();
      return;
    }
    i && (k.preventDefault(), i(k));
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(BarsOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S(), className: n.ListButton, ...d }, !n2 && (l ?? h(`${C ?? e2 ?? o2}.titles.list`, p(((B = m == null ? void 0 : m.meta) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? C ?? w(e2, o2), "plural")))));
}, "ListButton");
...
var dl = t(({ resourceNameOrRouteName: e2, resource: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let f = (0, import_react107.useContext)(ut), u = (s == null ? void 0 : s.enabled) ?? f.options.buttons.enableAccessControl, T = (s == null ? void 0 : s.hideIfUnauthorized) ?? f.options.buttons.hideIfUnauthorized, { cloneUrl: P } = le(), x = q(), F = ft(), { Link: p } = ae(), y = x === "legacy" ? p : F, h = _(), { id: m, resource: C } = N(o2 ?? e2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "create", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: u } }), S = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? P(C, n2 ?? m, l) : "";
  return u && T && !(a != null && a.can) ? null : import_react107.default.createElement(y, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S(), className: n.CloneButton, ...c }, !r && (i ?? h("buttons.clone", "Clone"))));
}, "CloneButton");
...
var Sl = t(({ canCreate: e2, title: o2, children: n2, createButtonProps: r, resource: s, wrapperProps: l, contentProps: i, headerProps: d, breadcrumb: c, headerButtonProps: f, headerButtons: u }) => {
  var S, v;
  let T = _(), { options: { breadcrumb: P } = {} } = se(), x = q(), F = Dt(), { resource: p, identifier: y } = N(s), h = e2 ?? (((p == null ? void 0 : p.canCreate) ?? !!(p != null && p.create)) || r), m = typeof c > "u" ? P : c, C = h ? { size: "middle", resource: x === "legacy" ? p == null ? void 0 : p.route : y, ...r } : void 0, a = h ? import_react109.default.createElement(Vo, { ...C }) : null;
  return import_react109.default.createElement("div", { ...l ?? {} }, import_react109.default.createElement(Se, { ghost: false, title: o2 ?? T(`${y}.titles.list`, F(((S = p == null ? void 0 : p.meta) == null ? void 0 : S.label) ?? ((v = p == null ? void 0 : p.options) == null ? void 0 : v.label) ?? (p == null ? void 0 : p.label) ?? y, "plural")), extra: u ? import_react109.default.createElement(space_default, { wrap: true, ...f }, typeof u == "function" ? u({ defaultButtons: a, createButtonProps: C }) : u) : a, breadcrumb: typeof m < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, m) ?? void 0 : import_react109.default.createElement(Be, null), ...d ?? {} }, import_react109.default.createElement("div", { ...i ?? {} }, n2)));
}, "List");
var Vl = t(({ title: e2, saveButtonProps: o2, children: n2, resource: r, isLoading: s = false, breadcrumb: l, wrapperProps: i, headerProps: d, contentProps: c, headerButtonProps: f, headerButtons: u, footerButtonProps: T, footerButtons: P, goBack: x }) => {
  var D, R;
  let F = _(), { options: { breadcrumb: p } = {} } = se(), y = q(), h = co(), { goBack: m } = le(), C = Dt(), { resource: a, action: S, identifier: v } = N(r), B = typeof l > "u" ? p : l, k = { ...s ? { disabled: true } : {}, ...o2, htmlType: "submit" }, g = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...k }));
  return import_react110.default.createElement("div", { ...i ?? {} }, import_react110.default.createElement(Se, { ghost: false, backIcon: x, onBack: S !== "list" || typeof S < "u" ? y === "legacy" ? m : h : void 0, title: e2 ?? F(`${v}.titles.create`, `Create ${C(((D = a == null ? void 0 : a.meta) == null ? void 0 : D.label) ?? ((R = a == null ? void 0 : a.options) == null ? void 0 : R.label) ?? (a == null ? void 0 : a.label) ?? v, "singular")}`), breadcrumb: typeof B < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, B) ?? void 0 : import_react110.default.createElement(Be, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...f ?? {} }, u ? typeof u == "function" ? u({ defaultButtons: null }) : u : null), ...d ?? {} }, import_react110.default.createElement(spin_default, { spinning: s }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...T ?? {} }, P ? typeof P == "function" ? P({ defaultButtons: g, saveButtonProps: k }) : P : g)], ...c ?? {} }, n2))));
}, "Create");
var ql = t(({ title: e2, saveButtonProps: o2, mutationMode: n2, recordItemId: r, children: s, deleteButtonProps: l, canDelete: i, resource: d, isLoading: c = false, dataProviderName: f, breadcrumb: u, wrapperProps: T, headerProps: P, contentProps: x, headerButtonProps: F, headerButtons: p, footerButtonProps: y, footerButtons: h, goBack: m, autoSaveProps: C }) => {
  var X, ne, ee;
  let a = _(), { options: { breadcrumb: S } = {} } = se(), { mutationMode: v } = ze(), B = n2 ?? v, k = q(), g = co(), D = me(), { goBack: R, list: E } = le(), z = Dt(), { resource: b, action: W, id: O2, identifier: U } = N(d), A = Mi({ resource: b, action: "list" }), Z2 = r ?? O2, L = typeof u > "u" ? S : u, I = (b == null ? void 0 : b.list) && !r, M = i ?? ((((X = b == null ? void 0 : b.meta) == null ? void 0 : X.canDelete) ?? (b == null ? void 0 : b.canDelete)) || l), j = I ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U } : void 0, Y = { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, recordItemId: Z2, dataProviderName: f }, $ = M ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, mutationMode: B, onSuccess: () => {
    k === "legacy" ? E((b == null ? void 0 : b.route) ?? (b == null ? void 0 : b.name) ?? "") : D({ to: A });
  }, recordItemId: Z2, dataProviderName: f, ...l } : void 0, H = { ...c ? { disabled: true } : {}, ...o2 }, q2 = import_react111.default.createElement(import_react111.default.Fragment, null, C && import_react111.default.createElement(Ut, { ...C }), I && import_react111.default.createElement(Ze, { ...j }), import_react111.default.createElement(_e, { ...Y })), K = import_react111.default.createElement(import_react111.default.Fragment, null, M && import_react111.default.createElement(Ye, { ...$ }), import_react111.default.createElement(Xe, { ...H }));
  return import_react111.default.createElement("div", { ...T ?? {} }, import_react111.default.createElement(Se, { ghost: false, backIcon: m, onBack: W !== "list" && typeof W < "u" ? k === "legacy" ? R : g : void 0, title: e2 ?? a(`${U}.titles.edit`, `Edit ${z(((ne = b == null ? void 0 : b.meta) == null ? void 0 : ne.label) ?? ((ee = b == null ? void 0 : b.options) == null ? void 0 : ee.label) ?? (b == null ? void 0 : b.label) ?? U, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...F ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: q2, listButtonProps: j, refreshButtonProps: Y }) : p : q2), breadcrumb: typeof L < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, L) ?? void 0 : import_react111.default.createElement(Be, null), ...P ?? {} }, import_react111.default.createElement(spin_default, { spinning: c }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...y ?? {} }, h ? typeof h == "function" ? h({ defaultButtons: K, deleteButtonProps: $, saveButtonProps: H }) : h : K)], ...x ?? {} }, s))));
}, "Edit");
var ap = t(({ title: e2, canEdit: o2, canDelete: n2, isLoading: r = false, children: s, resource: l, recordItemId: i, dataProviderName: d, breadcrumb: c, contentProps: f, headerProps: u, wrapperProps: T, headerButtons: P, footerButtons: x, footerButtonProps: F, headerButtonProps: p, goBack: y }) => {
  var Y, $, H;
  let h = _(), { options: { breadcrumb: m } = {} } = se(), C = q(), a = co(), S = me(), { goBack: v, list: B } = le(), k = Dt(), { resource: g, action: D, id: R, identifier: E } = N(l), z = Mi({ resource: g, action: "list" }), b = i ?? R, W = typeof c > "u" ? m : c, O2 = (g == null ? void 0 : g.list) && !i, U = n2 ?? ((Y = g == null ? void 0 : g.meta) == null ? void 0 : Y.canDelete) ?? (g == null ? void 0 : g.canDelete), A = o2 ?? (g == null ? void 0 : g.canEdit) ?? !!(g != null && g.edit), Z2 = O2 ? { resource: C === "legacy" ? g == null ? void 0 : g.route : E } : void 0, L = A ? { ...r ? { disabled: true } : {}, type: "primary", resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b } : void 0, I = U ? { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, onSuccess: () => {
    C === "legacy" ? B((g == null ? void 0 : g.route) ?? (g == null ? void 0 : g.name) ?? "") : S({ to: z });
  }, dataProviderName: d } : void 0, M = { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, dataProviderName: d }, j = import_react112.default.createElement(import_react112.default.Fragment, null, O2 && import_react112.default.createElement(Ze, { ...Z2 }), A && import_react112.default.createElement(Ho, { ...L }), U && import_react112.default.createElement(Ye, { ...I }), import_react112.default.createElement(_e, { ...M }));
  return import_react112.default.createElement("div", { ...T ?? {} }, import_react112.default.createElement(Se, { ghost: false, backIcon: y, onBack: D !== "list" && typeof D < "u" ? C === "legacy" ? v : a : void 0, title: e2 ?? h(`${E}.titles.show`, `Show ${k((($ = g == null ? void 0 : g.meta) == null ? void 0 : $.label) ?? ((H = g == null ? void 0 : g.options) == null ? void 0 : H.label) ?? (g == null ? void 0 : g.label) ?? E, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...p ?? {} }, P ? typeof P == "function" ? P({ defaultButtons: j, deleteButtonProps: I, editButtonProps: L, listButtonProps: Z2, refreshButtonProps: M }) : P : j), breadcrumb: typeof W < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, W) ?? void 0 : import_react112.default.createElement(Be, null), ...u ?? {} }, import_react112.default.createElement(spin_default, { spinning: r }, import_react112.default.createElement(card_default, { bordered: false, actions: x ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...F }, typeof x == "function" ? x({ defaultButtons: null }) : x)] : void 0, ...f ?? {} }, s))));
}, "Show");
...
var xp = t(({ value: e2, imageTitle: o2, ...n2 }) => import_react116.default.createElement(image_default, { ...n2, src: e2, title: o2 }), "ImageField");
...
var zp = t(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { plugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var $p = t((e2) => {
  let { setSelectedKeys: o2, confirm: n2, clearFilters: r, mapValue: s, selectedKeys: l, children: i } = e2, [d, c] = (0, import_react123.useState)(l), f = _(), u = t(() => {
    r && (c([]), r());
  }, "clearFilter"), T = t(() => {
    let p = P(d), y;
    typeof p == "number" ? y = `${p}` : import_dayjs6.default.isDayjs(p) ? y = [p.toISOString()] : y = p, o2(y), n2 == null || n2();
  }, "onFilter"), P = t((p) => s ? s(p) : p, "mappedValue"), x = t((p) => {
    if (typeof p == "object") {
      if (Array.isArray(p)) {
        let a = P(p);
        return c(a), o2(a);
      }
      let h = !p || !p.target || import_dayjs6.default.isDayjs(p) ? { target: { value: p } } : p, { target: m } = h, C = P(m.value);
      c(C);
      return;
    }
    let y = P(p);
    c(y);
  }, "onChange"), F = import_react123.default.Children.map(i, (p) => import_react123.default.isValidElement(p) ? import_react123.default.cloneElement(p, { onChange: x, value: P(d) }) : p);
  return import_react123.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react123.default.createElement("div", { style: { marginBottom: 15 } }, F), import_react123.default.createElement(space_default, null, import_react123.default.createElement(button_default, { type: "primary", size: "small", onClick: () => T() }, import_react123.default.createElement(FilterOutlined_default, null), " ", f("buttons.filter", "Filter")), import_react123.default.createElement(button_default, { danger: true, size: "small", onClick: () => u() }, f("buttons.clear", "Clear"))));
}, "FilterDropdown");
var { Text: au } = typography_default;
var iu = t(() => {
  let [e2, o2] = (0, import_react124.useState)(), n2 = _(), { push: r } = le(), s = me(), l = q(), { resource: i, action: d } = N();
...
var Ot = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var Mt = { maxWidth: "408px", margin: "auto" };
var Nt = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var Qt = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var { Text: bu, Title: hu2 } = typography_default;
var xu = t(() => {
  let [e2] = form_default.useForm(), o2 = _(), n2 = Z(), { mutate: r, isLoading: s } = Gt({ v3LegacyAuthProviderCompatible: !!(n2 != null && n2.isLegacy) }), l = import_react125.default.createElement(hu2, { level: 3, style: Nt }, o2("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: Ot }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Mt }, import_react125.default.createElement("div", { style: Qt }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: l, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (i) => {
    r(i);
...
var Du = t(() => se2.createElement(row_default, { align: "middle", justify: "center", style: Ae.root }, se2.createElement(col_default, { style: { textAlign: "center" } }, se2.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), se2.createElement(ku, { style: Ae.title }, "Welcome on board"), se2.createElement("p", { style: Ae.p1 }, "Your configuration is completed."), se2.createElement("p", { style: Ae.p2 }, "Now you can get started by adding your resources to the", " ", se2.createElement("code", { style: Ae.code }, "resources"), " property of", " ", se2.createElement("code", { style: Ae.code }, "<Refine>")), se2.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, se2.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, se2.createElement(button_default, { size: "large", icon: se2.createElement(ReadOutlined_default, null) }, "Documentation")), se2.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, se2.createElement(button_default, { size: "large", icon: se2.createElement(FolderOutlined_default, null) }, "Examples")), se2.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, se2.createElement(button_default, { size: "large", icon: se2.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
...
var { Text: Kt, Title: $u } = typography_default;
var { useToken: qu } = theme_default;
var Go = t(({ providers: e2, registerLink: o2, forgotPasswordLink: n2, rememberMe: r, contentProps: s, wrapperProps: l, renderContent: i, formProps: d, title: c }) => {
  let { token: f } = qu(), [u] = form_default.useForm(), T = _(), P = q(), x = ft(), { Link: F } = ae(), p = P === "legacy" ? F : x, y = Z(), { mutate: h, isLoading: m } = Gt({ v3LegacyAuthProviderCompatible: !!(y != null && y.isLegacy) }), C = c === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, c ?? import_react128.default.createElement(ce, { collapsed: false })), a = import_react128.default.createElement($u, { level: 3, style: { color: f.colorPrimaryTextHover, ...Ee } }, T("pages.login.title", "Sign in to your account")), S = t(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((B) => import_react128.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => h({ providerName: B.name }) }, B.label)), import_react128.default.createElement(divider_default, null, import_react128.default.createElement(Kt, { style: { color: f.colorTextLabel } }, T("pages.login.divider", "or")))) : null, "renderProviders"), v = import_react128.default.createElement(card_default, { title: a, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: f.colorBgElevated }, ...s ?? {} }, S(), import_react128.default.createElement(form_default, { layout: "vertical", form: u, onFinish: (B) => h(B), requiredMark: false, initialValues: { remember: false }, ...d }, import_react128.default.createElement(form_default.Item, { name: "email", label: T("pages.login.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: T("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: T("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: T("pages.login.fields.password", "Password"), rules: [{ required: true }] }, import_react128.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, r ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, T("pages.login.buttons.rememberMe", "Remember me"))), n2 ?? import_react128.default.createElement(p, { style: { color: f.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, T("pages.login.buttons.forgotPassword", "Forgot password?"))), import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: m, block: true }, T("pages.login.signin", "Sign in")))), import_react128.default.createElement("div", { style: { marginTop: 8 } }, o2 ?? import_react128.default.createElement(Kt, { style: { fontSize: 12 } }, T("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(p, { to: "/register", style: { fontWeight: "bold", color: f.colorPrimaryTextHover } }, T("pages.login.signup", "Sign up")))));
  return import_react128.default.createElement(layout_default, { style: ve, ...l ?? {} }, import_react128.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react128.default.createElement(col_default, { xs: 22 }, i ? i(v, C) : import_react128.default.createElement(import_react128.default.Fragment, null, C, v))));
}, "LoginPage");
var { Text: qt, Title: ld } = typography_default;
var { useToken: pd } = theme_default;
var $o = t(({ providers: e2, loginLink: o2, wrapperProps: n2, contentProps: r, renderContent: s, formProps: l, title: i }) => {
  let { token: d } = pd(), [c] = form_default.useForm(), f = _(), u = q(), T = ft(), { Link: P } = ae(), x = u === "legacy" ? P : T, F = Z(), { mutate: p, isLoading: y } = Zr({ v3LegacyAuthProviderCompatible: !!(F != null && F.isLegacy) }), h = i === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react129.default.createElement(ce, { collapsed: false })), m = import_react129.default.createElement(ld, { level: 3, style: { color: d.colorPrimaryTextHover, ...Ee } }, f("pages.register.title", "Sign up for your account")), C = t(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((S) => import_react129.default.createElement(button_default, { key: S.name, type: "default", block: true, icon: S.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => p({ providerName: S.name }) }, S.label)), import_react129.default.createElement(divider_default, null, import_react129.default.createElement(qt, { style: { color: d.colorTextLabel } }, f("pages.login.divider", "or")))) : null, "renderProviders"), a = import_react129.default.createElement(card_default, { title: m, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: d.colorBgElevated }, ...r ?? {} }, C(), import_react129.default.createElement(form_default, { layout: "vertical", form: c, onFinish: (S) => p(S), requiredMark: false, ...l }, import_react129.default.createElement(form_default.Item, { name: "email", label: f("pages.register.email", "Email"), rules: [{ required: true }, { type: "email", message: f("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: f("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: f("pages.register.fields.password", "Password"), rules: [{ required: true }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, o2 ?? import_react129.default.createElement(qt, { style: { fontSize: 12, marginLeft: "auto" } }, f("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(x, { style: { fontWeight: "bold", color: d.colorPrimaryTextHover }, to: "/login" }, f("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: y, block: true }, f("pages.register.buttons.submit", "Sign up")))));
  return import_react129.default.createElement(layout_default, { style: ve, ...n2 ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react129.default.createElement(col_default, { xs: 22 }, s ? s(a, h) : import_react129.default.createElement(import_react129.default.Fragment, null, h, a))));
}, "RegisterPage");
var { Text: Fd, Title: Bd } = typography_default;
var { useToken: Sd } = theme_default;
var qo = t(({ loginLink: e2, wrapperProps: o2, contentProps: n2, renderContent: r, formProps: s, title: l }) => {
  let { token: i } = Sd(), [d] = form_default.useForm(), c = _(), f = q(), u = ft(), { Link: T } = ae(), P = f === "legacy" ? T : u, { mutate: x, isLoading: F } = Jr(), p = l === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, l ?? import_react130.default.createElement(ce, { collapsed: false })), y = import_react130.default.createElement(Bd, { level: 3, style: { color: i.colorPrimaryTextHover, ...Ee } }, c("pages.forgotPassword.title", "Forgot your password?")), h = import_react130.default.createElement(card_default, { title: y, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: i.colorBgElevated }, ...n2 ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (m) => x(m), requiredMark: false, ...s }, import_react130.default.createElement(form_default.Item, { name: "email", label: c("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: c("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: c("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(Fd, { style: { fontSize: 12, marginLeft: "auto" } }, c("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(P, { style: { fontWeight: "bold", color: i.colorPrimaryTextHover }, to: "/login" }, c("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: F, block: true }, c("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ve, ...o2 ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react130.default.createElement(col_default, { xs: 22 }, r ? r(h, p) : import_react130.default.createElement(import_react130.default.Fragment, null, p, h))));
}, "ForgotPasswordPage");
var { Title: Ad } = typography_default;
var { useToken: Hd } = theme_default;
var Yo = t(({ wrapperProps: e2, contentProps: o2, renderContent: n2, formProps: r, title: s }) => {
  let { token: l } = Hd(), [i] = form_default.useForm(), d = _(), c = Z(), { mutate: f, isLoading: u } = eo({ v3LegacyAuthProviderCompatible: !!(c != null && c.isLegacy) }), T = s === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, s ?? import_react131.default.createElement(ce, { collapsed: false })), P = import_react131.default.createElement(Ad, { level: 3, style: { color: l.colorPrimaryTextHover, ...Ee } }, d("pages.updatePassword.title", "Set New Password")), x = import_react131.default.createElement(card_default, { title: P, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: l.colorBgElevated }, ...o2 ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: i, onFinish: (F) => f(F), requiredMark: false, ...r }, import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true }, ({ getFieldValue: F }) => ({ validator(p, y) {
    return !y || F("password") === y ? Promise.resolve() : Promise.reject(new Error(d("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  } })] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: u, block: true }, d("pages.updatePassword.buttons.submit", "Update")))));
  return import_react131.default.createElement(layout_default, { style: ve, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react131.default.createElement(col_default, { xs: 22 }, n2 ? n2(x, T) : import_react131.default.createElement(import_react131.default.Fragment, null, T, x))));
}, "UpdatePasswordPage");
var Od = t((e2) => {
  let { type: o2 } = e2;
...
var Be = t(({ breadcrumbProps: e2, showHome: o2 = true, hideIcons: n2 = false, meta: r }) => {
  let s = q(), { breadcrumbs: l } = Pb({ meta: r }), i = ft(), { Link: d } = ae(), { hasDashboard: c } = se(), { resources: f } = N(), u = Mo("/", f), T = s === "legacy" ? d : i;
  if (l.length === 1)
    return null;
  let P = l.map(({ label: F, icon: p, href: y }) => ({ key: `breadcrumb-item-${F}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !n2 && p, y ? import_react132.default.createElement(T, { to: y }, F) : import_react132.default.createElement("span", null, F)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: t(() => {
    var F, p;
    return o2 && (c || u.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(T, { to: "/" }, ((p = (F = u == null ? void 0 : u.resource) == null ? void 0 : F.meta) == null ? void 0 : p.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...P] : P;
...
var Ut = t(({ status: e2, elements: { success: o2 = import_react134.default.createElement(po, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: n2 = import_react134.default.createElement(po, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: r = import_react134.default.createElement(po, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: s = import_react134.default.createElement(po, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(Lu, { status: e2, elements: { success: o2, error: n2, loading: r, idle: s } }), "AutoSaveIndicator");
